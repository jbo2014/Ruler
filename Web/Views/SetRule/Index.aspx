            ...
            <div class="wrapper wrapper-content">
                <div class="middle-box text-center animated fadeInRightBig">
                    <form action="/" method="post">
                        ...
                        规则内容：<input type="button" name="AddRule" value="添加规则" /><br/>
                        When：<input type="text" name="When" value=" " /><br/>
                        Then：<input type="text" name="Then" value=" " /><br/>
                        Else：<input type="text" name="Else" value=" " /><br/>
                        <input type="button" name="Save" value="保存" /><input type="button" name="Cancel" value="取消" />
                    </form>
                </div>
            </div>
</asp:Content>